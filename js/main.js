// FORM CONNECT
let phoneArr = []
let fullPhone = document.querySelectorAll("input[name=full-phone]");
let userIp = document.querySelectorAll('input[name=client_ip]');
...
function initForm() {
    ...
    let form = document.querySelectorAll('.form-registration');
